...
import { CreateOptions } from '../interfaces/services/prisma/create-option';
import { UpdateOptions } from '../interfaces/services/prisma/update-option';
import { DeleteOptions } from '../interfaces/services/prisma/delete-option';
...
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
    ...
    private static getRequestContextService(): RequestContextService {
        if (!PrismaService.requestContextService) {
            PrismaService.requestContextService = RequestContextServiceProvider.getService();
        }
